...
(function () {
  ...
  async function viewHistorico() {
    return `<div class="view">
      ...
      ${emptyState('📊', 'Ainda sem folhas conferidas', 'Quando você conferir e aprovar uma folha, ela fica guardada aqui.')}
      <div class="notice">Aqui vai aparecer, a cada nova folha: quem <b>mudou de cargo</b>, quem <b>saiu</b> (estava na folha passada e sumiu), quem <b>entrou</b>, e variações de salário. Depende do motor de leitura de folha (próximo passo).</div>
    </div>`;
  }
  ...
  document.addEventListener('click', async (ev) => {
    const t = ev.target.closest('[data-go],[data-close],[data-open-conv],[data-new-sind],[data-edit-sind],[data-del-sind],[data-save-sind],[data-new-conv],[data-import-conv],[data-edit-conv],[data-del-conv],[data-save-conv],[data-regras],[data-add-piso],[data-add-est],[data-add-ben],[data-rm-row],[data-save-regras],[data-aprov],[data-new-emp],[data-edit-emp],[data-del-emp],[data-save-emp],[data-conf-emp],[data-conv],[data-toggle],[data-export],[data-new-clt],[data-config],[data-save-config],[data-mediador],[data-mediador-open],[data-mediador-update],[data-seed-demo]');
    if (!t) return;
  ...
  async function atualizarConvencaoDoMediador(oldId) {
    ...
    inp.onchange = async () => {
      ...
      try {
        ...
        const novo = await importConvencao(bundle, { silent: true });
        if (!novo) return;
